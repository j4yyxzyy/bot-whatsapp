...
END:VCARD
 ...
 conn.fakeReply = (jid, text = '', fakeJid = conn.user.jid, fakeText = '', fakeGroupJid, options) => {
     ...
     * @param {Object} options 
     */
    conn.sendButton = async (jid, content, footer, button1, id1, quoted, options) => {
        const buttons = [
    ...
    conn.send2Button = async (jid, content, footer, button1, id1, button2, id2, quoted, options) => {
        const buttons = [
        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
    ...
    conn.send3Button = async (jid, content, footer, button1, id1, button2, id2, button3, id3, quoted, options) => {
        const buttons = [
        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
        { buttonId: id2, buttonText: { displayText: button2 }, type: 1 },
